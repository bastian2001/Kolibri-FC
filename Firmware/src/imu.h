...
extern DualPT1 vVel; // vertical velocity of the drone (up = positive, m/s)
extern DualPT1 combinedAltitude; // altitude of the drone (in meters ASL) by combining the barometer, GPS and the accelerometer
