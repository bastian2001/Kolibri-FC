...
void initPid() {
	...
	addSetting(SETTING_IRELAX_CUTOFF, &iRelaxCutoff, 20);
	addSetting(SETTING_FF_CUTOFF, &ffCutoff, 12);
...
void pidLoop() {
	...
	// FF Filter
	ffFilter[AXIS_ROLL].update(((rollSetpoint - lastSetpoints[AXIS_ROLL]) >> 4) * 3200);
