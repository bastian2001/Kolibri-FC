...
bool testFixedPoint() {
	...
	fix64 d = fix64::fromRaw(0b101LL << 31);
	b = b * d;
	Expect(b.getf32()).withIndex(68).toEqual(6.25);
	b = 2.5;
	d = b.multiply64(d);
	Expect(d.getf32()).withIndex(69).toEqual(6.25);
	b = d;
	Expect(b.getf32()).withIndex(70).toEqual(6.25);
	d = fix64::fromRaw(0b101LL << 32);
	Expect(d.getf32()).withIndex(71).toEqual(5);
	d = fix64(2);
	Expect(d.getf32()).withIndex(72).toEqual(2);
	d = fix64(2.5f);
	Expect(d.getf32()).withIndex(73).toEqual(2.5);
	Expect(d.setRaw(0b101LL << 30).getf32()).withIndex(74).toEqual(1.25);
	Expect(d.getRaw()).withIndex(75).toEqual(0b101LL << 30);
	Expect(d.getf64()).withIndex(76).toEqual(1.25);
	Expect(d.getInt()).withIndex(77).toEqual(1);
	Expect(d.toFixed32().getf32()).withIndex(78).toEqual(1.25);
	d = d + fix64(2.5f);
	Expect(d.getf32()).withIndex(79).toEqual(3.75);
	d = d - fix64(2.5f);
	Expect(d.getf32()).withIndex(80).toEqual(1.25);
	d = d - fix64(2.5f);
	Expect(d.getf32()).withIndex(81).toEqual(-1.25);
	d = d + fix32(0.5f);
	Expect(d.getf32()).withIndex(82).toEqual(-0.75);
	d = d - fix32(0.5f);
	Expect(d.getf32()).withIndex(83).toEqual(-1.25);
	d += fix32(0.5f);
	Expect(d.getf32()).withIndex(84).toEqual(-0.75);
	d = d * d;
	Expect(d.getf32()).withIndex(85).toEqual(0.5625);
	d = d * fix32(2.5);
	Expect(d.getf32()).withIndex(86).toEqual(1.40625);
	d = d * 2;
	Expect(d.getf32()).withIndex(87).toEqual(2.8125);
	d = 2.5;
	d = d.multiply64(fix32(2.5));
	Expect(d.getf32()).withIndex(88).toEqual(6.25);
	d = 2;
	Expect(d.getRaw()).withIndex(89).toEqual(2LL << 32);
	d = 2LL;
	Expect(d.getRaw()).withIndex(90).toEqual(2LL << 32);
	d = fix32(2.5);
	Expect(d.getRaw()).withIndex(91).toEqual(0b101LL << 31);
	d = 2.5f;
	Expect(d.getRaw()).withIndex(92).toEqual(0b101LL << 31);
	d = 2.5;
	Expect(d.getRaw()).withIndex(93).toEqual(0b101LL << 31);
	d = d >> 2;
	Expect(d.getf32()).withIndex(94).toEqual(0.625);
	d = -d;
	Expect(d.getf32()).withIndex(95).toEqual(-0.625);
	fix64 e;
	e = 2.5;
	d = 2.5;
	Expect(e < d).withIndex(96).toEqual(false);
	Expect(e > d).withIndex(97).toEqual(false);
	e = 2.6;
	Expect(d < e).withIndex(98).toEqual(true);
	Expect(d > e).withIndex(99).toEqual(false);
	Expect(e < d).withIndex(100).toEqual(false);
	Expect(e > d).withIndex(101).toEqual(true);
