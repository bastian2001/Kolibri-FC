...
#define uart_rx_wrap 7

static const uint16_t uart_rx_program_instructions[] = {
	//     .wrap_target
	0x2f20, //  0: wait   0 pin, 0               [15]
	0xff27, //  1: set    x, 7                   [31]
	0x5e01, //  2: in     pins, 1                [30]
	0x0042, //  3: jmp    x--, 2
	0x00c7, //  4: jmp    pin, 7
	0xa0c3, //  5: mov    isr, null
	0x1d00, //  6: jmp    0                      [29]
	0x8520, //  7: push   block                  [5]
	//     .wrap
};
